...
if (WebUI.waitForPageLoad(30) == false) {
    KeywordUtil.markFailedAndStop('Page did not load within 30 seconds')
} else {
	...
	WebUI.setText(findTestObject('Object Repository/01 - Demo Materials - Manual/Self-Healing Objects/Page_Katalian Bank  Private Wealth Management/input_username_broken'), username)
	WebUI.setEncryptedText(findTestObject('01 - Demo Materials - Manual/Self-Healing Objects/Page_Katalian Bank  Private Wealth Management/input_password'), 'CS9RmWxFPRFoMJc95WUBEN4WG8mxfTJo')
