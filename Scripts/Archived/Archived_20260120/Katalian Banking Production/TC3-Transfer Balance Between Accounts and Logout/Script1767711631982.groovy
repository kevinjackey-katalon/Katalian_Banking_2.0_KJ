...
"Step 4: Click on button confirmTransfer -> Navigate to page '/dashboard'"
...
// WebUI.takeScreenshot(reportLocation + '/TC3/Step 4-Click on button confirmTransfer - Navigate to page dashboard.png')

"Step 5: Click on button logout -> Navigate to page ''"

WebUI.enhancedClick(findTestObject('Archived/Archived_20260120/Katalian Banking Production/Page_dashboard/button_logout'))

// WebUI.takeScreenshot(reportLocation + '/TC3/Step 5-Click on button logout - Navigate to page .png')

"Step 6: Take full page screenshot as checkpoint"

WebUI.takeFullPageScreenshotAsCheckpoint('TC3-Transfer Balance Between Accounts and Logout_visual_checkpoint')
