...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_dashboard/button_moveFunds'))
...
TrueTestScripts.selectOption(findTestObject('AI-Generated/Katalian Banking Production/Page_transfer/select_recipientFacility'), select_recipientFacility, "label", false)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_transfer/button_payFullBalance'))

// WebUI.takeScreenshot(reportLocation + '/TC16/Step 8-Click on button payFullBalance.png')

"Step 9: Click on button reviewProtocol2"

WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_transfer/button_reviewProtocol2'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_transfer/button_authorizePayment'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_dashboard/div_creditCard'))
