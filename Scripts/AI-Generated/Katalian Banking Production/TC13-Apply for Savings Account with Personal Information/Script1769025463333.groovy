...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_dashboard/button_savings'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/input_legalFirstName'))
...
WebUI.setText(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/input_legalFirstName'), input_legalFirstName)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/input_middleName'))
...
WebUI.setText(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/input_middleName'), input_middleName)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/input_legalLastName'))
...
WebUI.setText(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/input_legalLastName'), input_legalLastName)
...
WebUI.setText(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/input_dateOfBirth'), input_dateOfBirth)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/button_continue'))

// WebUI.takeScreenshot(reportLocation + '/TC13/Step 13-Click on button continue.png')

"Step 14: Click on input primaryAddressLine"

WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/input_primaryAddressLine'))
...
WebUI.setText(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/input_primaryAddressLine'), input_primaryAddressLine)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/input_city'))

// WebUI.takeScreenshot(reportLocation + '/TC13/Step 16-Click on input city.png')

"Step 17: Enter input value in input city"

WebUI.setText(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/input_city'), input_city)
...
TrueTestScripts.selectOption(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/select_state'), select_state, "label", false)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/input_zipCode'))

// WebUI.takeScreenshot(reportLocation + '/TC13/Step 19-Click on input zipCode.png')

"Step 20: Enter input value in input zipCode"

WebUI.setText(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/input_zipCode'), input_zipCode)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_apply_Savings/button_enterFacilityDashboard'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_dashboard/div_savingsCard'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking Production/Page_account/button_signOut'))
