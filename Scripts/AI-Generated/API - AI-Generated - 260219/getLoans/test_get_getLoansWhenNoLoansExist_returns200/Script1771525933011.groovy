...
def responseJson = slurper.parseText(getLoansResponse.getResponseBodyContent())

assert responseJson instanceof List : "Response is not a list"
assert responseJson.size() == 0 : "Expected empty list, got ${responseJson.size()} items"
