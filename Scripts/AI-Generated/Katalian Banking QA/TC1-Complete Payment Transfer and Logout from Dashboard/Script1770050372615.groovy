...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking QA/Page_dashboard/button_payments'))
...
TrueTestScripts.selectOption(findTestObject('AI-Generated/Katalian Banking QA/Page_transfer/select_originLiquidity'), select_originLiquidity, "label", false)
...
TrueTestScripts.selectOption(findTestObject('AI-Generated/Katalian Banking QA/Page_transfer/select_recipientFacility'), select_recipientFacility, "label", false)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking QA/Page_transfer/input_liquidCapitalAmount'))
...
WebUI.setText(findTestObject('AI-Generated/Katalian Banking QA/Page_transfer/input_liquidCapitalAmount'), input_liquidCapitalAmount)
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking QA/Page_transfer/button_reviewProtocol'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking QA/Page_transfer/button_authorizePayment'))
...
WebUI.enhancedClick(findTestObject('AI-Generated/Katalian Banking QA/Page_dashboard/button_signOut'))
