package truetest.Katalian_Banking_Production.custom
...
public class TrueTestScripts {
    ...
    public static void login(Map parameters = [:]) {
        try {
            ...
            // import com.kms.katalon.core.webui.keyword.WebUiBuiltInKeywords as WebUI
            WebUI.callTestCase(findTestCase('Test Cases/01 - Demo Materials - Manual/Self Healing_Data Binding Demonstration/Login - Self Healing_Data Binding Demonstration'), [:], FailureHandling.CONTINUE_ON_FAILURE)
